...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || 'pv_25_review.gltf',
...
function createAppInstance(containerId, initOptions, preloader, PE) {
    const ctxSettings = {};
    ctxSettings.webglErrorMsg = `Для просмотра 3D-модели «ЭЛЕМЕР-PV-25» требуется современный браузер.

К сожалению, ваше устройство не поддерживает WebGL. Пожалуйста, обновите ваш браузер.`;
